...
export default class WeaponManager {
  ...
  initializeEventListeners() {
    UserInputEventPipe.addEventListener(
      UserInputEvent.type,
      this.handleUserInput
    );
    GameEventPipe.addEventListener(
      WeaponFireEvent.type,
  ...
  handleWeaponFiring = (e) => {
    if (
      e.detail.weapon &&
      e.detail.weapon.classification !== WeaponEnum.MELEE
    ) {
  ...
  processRaycasting = (e) => {
    ...
    this.intersectedObjects.filter(
      (intersectedObject) =>
        intersectedObject.object.userData["type"] === MaterialsEnum.LEVEL
    );
  ...
  handlePlayerHit = (intersectedObject, e) => {
    const playerInstance =
      intersectedObject.object.parent.parent.parent.userData.instance;
