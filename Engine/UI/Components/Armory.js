...
export default class Armory extends Component {
  ...
  onClick(e) {
    ...
    switch (e.target.dataset.weapon) {
      case "M416":
        this.engine.network.getLocalPlayer().destroyAWP();
        this.engine.network.getLocalPlayer().createM416();
        break;
      case "AWP":
        this.engine.network.getLocalPlayer().destroyM416();
        this.engine.network.getLocalPlayer().createAWP();
        break;
    }
  }
}
